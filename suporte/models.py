...
class Ticket(models.Model):
    titulo_text = models.CharField(max_length=200)
    descricao_text = models.CharField(max_length=200)
    prioridade_text = models.CharField(max_length=200, null=True, blank=True)
    departamento_text = models.CharField(max_length=200,choices=CRC_CHOICES, null=True, blank=True)
    autor_text = models.CharField(max_length=200)
    ticket_id = models.CharField(max_length=255, null=True, blank=True)
    ticket_email = models.CharField(max_length=255)
...
class Dialogo(models.Model):
    ...
    #dialogo_date = models.DateTimeField('date published')
